...
(function () {
  ...
  var createMethodMy = function (bits, padding) {
    var method = createOutputMethodMy(bits, padding, 'hex');
    method.create = function () {
      return new Keccak(bits, padding, 1600);
    };
    method.update = function (message) {
      return method.create().update(message);
    };
    return createOutputMethods(method, createOutputMethodMy, bits, padding);
  };
  ...
  var algorithms = [
    ...
    { name: 'mykeccak', padding: KECCAK_PADDING, bits: BITS, createMethod: createMethodMy },
