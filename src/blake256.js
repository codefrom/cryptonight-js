...
Uint8Array.prototype.writeUInt32BE = function writeUInt32BE (value, offset, noAssert) {
  value = +value
  offset = offset >>> 0
...
Uint8Array.prototype.readUInt32BE = function readUInt32BE (offset, noAssert) {
  offset = offset >>> 0
...
'use strict'
var zo = new Uint8Array([0x01])
var oo = new Uint8Array([0x81])
...
Blake256.padding = new Uint8Array([
...
Blake256.prototype.update = function (data) {
